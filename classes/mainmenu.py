...
class MainMenu:
    def __init__(self, app):
        ...
        self.buttons = [buttons.Button(200 * self.app.scale, 75 * self.app.scale, self.app.width/2 - 100 * self.app.scale, self.app.height/2 - 75 * self.app.scale/2, False, self.font, "Start", (0, 0, 0), self.font_color, 'start', self.app)]
    ...
    def render(self):
        ...
        for button in self.buttons:
            ...
            display_text = font.render("T E T R I S", True, self.font_color)
